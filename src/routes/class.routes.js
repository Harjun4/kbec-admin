...
router.post('/', requireAuth, requireRole('Super Admin', 'Admin'), classController.createClass);
router.put('/:id', requireAuth, requireRole('Super Admin', 'Admin'), classController.updateClass);
